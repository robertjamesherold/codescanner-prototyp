...
const RecommendedStepCard = ({
  ...
  return (
    <div data-layer="RecommendedStepCard" className="flex h-full w-full flex-col overflow-hidden rounded-md border border-border-2 bg-grouped-1 shadow-md [--surface:var(--grouped-1)]">
      {/* Header (getönt) */}
